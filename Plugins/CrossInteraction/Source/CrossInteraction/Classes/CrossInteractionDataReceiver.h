...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CrossInteraction")
		void SendBoxOpenMsg(const int32 ID);

	UFUNCTION(BlueprintCallable, Category = "CrossInteraction")
		void SendBillboardMsg(TArray<FCIBillboardProp> BillboardProps, const int32 count);
	...
	UFUNCTION(BlueprintCallable, Category = "CrossInteraction")
		void SendWWJMsg(const int32 ID, const int32 status);
	...
	UFUNCTION(BlueprintCallable, Category = "CrossInteraction")
		void SendLevelNameMsg(FName name);

	UFUNCTION(BlueprintCallable, Category = "CrossInteraction")
		void SendCustomMsg(FString msg);
